...
function SeccionProductos({ titulo, productos = [], reload = false }) {
    ...
    return (
        <>
            ...
            <div className="botones"><button className="btn-prev" onClick={prev} disabled={startIndex === 0}><img src="/imagesideas/correrizq.png" className="mario" /></button>
            <button className="btn-next" onClick={next} disabled={startIndex + maxitems >= productos.length}><img src="/imagesideas/correr.png" className="mario mario-right" /></button></div>
            </div>
