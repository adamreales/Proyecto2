  ...
  return (
      <div className="MisDatos">
        ...
        <form onSubmit={handleSubmit} className="MisDatos-form">
          <input  type="text"name="name" value={form.name} onChange={onChange}    placeholder="Nombre" required />

          <input type="email" name="email" value={form.email}onChange={onChange} placeholder="Correo electrónico"     required/>

          <input type="password"    name="password"  value={form.password} onChange={onChange} placeholder="Nueva contraseña (opcional)"/>

          <input type="password"name="password_confirmation" value={form.password_confirmation}       onChange={onChange}          placeholder="Confirmar nueva contraseña"  />
